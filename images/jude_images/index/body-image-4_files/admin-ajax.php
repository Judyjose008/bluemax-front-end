...
.ts-mmmenu-override-yes #site-header-menu #site-navigation div.mega-menu-wrap ul.mega-menu.mega-menu-horizontal li.mega-menu-item ul.mega-sub-menu, #site-header-menu #site-navigation div.nav-menu > ul > li ul > .ts-bg-layer{background-color:#7fc540;}
 ...
 div.ts-titlebar-wrapper{background-image:url('http://optico.themestek.com/demo1/wp-content/uploads/sites/12/2021/04/titlebarbg1.jpg');background-color:rgba(44,30,15,0.69);background-position:right center;background-size:cover;background-repeat:no-repeat;background-attachment:scroll;}
...
.error404 .site-content-wrapper > .ts-bg-layer{background-color:rgba(23,23,23,0.80);}
 .uconstruction_background{background-image:url('http://optico.themestek.com/wp-content/themes/optico/images/uconstruction-bg.jpg');background-color:#222222;background-position:center top;background-size:cover;background-repeat:no-repeat;background-attachment:fixed;}
 ...
 * ----------------------------------------------------------------------------
 */
.ts-page-loader-wrapper{background-image:url(https://optico.themestek.com/demo1/wp-content/themes/optico/images/loader1.gif)}
/**
 * 0. Floating bar
 * ----------------------------------------------------------------------------
 */
...
.ts-textcolor-skincolor .ts-vc_cta3-content-header h4{
	color: rgba( 127,197,64 , 0.90) !important;
}
.ts-textcolor-skincolor .ts-vc_cta3-content .ts-cta3-description{
	color: rgba( 127,197,64 , 0.60) !important;
}
.ts-textcolor-skincolor{
	color: rgba( 127,197,64 , 0.60);
}
.ts-textcolor-skincolor a{
	color: rgba( 127,197,64 , 0.80);
}
...
.themestek-portfolio-box-view-overlay-two-icon-skin.themestek-box-view-overlay .themestek-overlay{
	background-color: rgba( 127,197,64 , 0.80);
}
...
.main-form .select2-container--default .select2-selection--single .select2-selection__arrow b {
    border-color: #7fc540 transparent transparent transparent;
}
.main-form  .select2-container--default.select2-container--open .select2-selection--single .select2-selection__arrow b {
    border-color: transparent transparent #7fc540 transparent;
...
span.ts-vc_label_units.vc_label_units:before{ 
	border-color: #7fc540 transparent; 
}
...
.slick-dots li.slick-active button{
	box-shadow: inset 0 0 0 2px #7fc540;
}
...
/***  Tm Header Style Infostack ***/   
    ...
    .ts-header-style-infostack #site-header-menu #site-navigation .ts-header-icon.ts-header-btn-w a{
        ...
        display: block;
        letter-spacing: 1px;      
        background-color: rgba( 127,197,64 , 1);
        -webkit-transition: all 0.3s ease;
        -moz-transition: all 0.3s ease;
        -ms-transition: all 0.3s ease;
        -o-transition: all 0.3s ease;
    ...
    .ts-header-overlay .site-header.ts-bgcolor-skincolor{
        background-color: rgba( 127,197,64 , 0.30);
    }    
